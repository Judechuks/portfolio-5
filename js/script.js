...
/*========== SECTION'S ACTIVE LINK WHILE SCROLLING ==========*/
...
// When the scroll is greater than 80vh, add the scroll-header class
if(this.scrollY >= 80)
...
function scrollUp(){
  ...
  // When the scroll is higher than 560vh, add the show-scroll class
  if(this.scrollY >= 560)
